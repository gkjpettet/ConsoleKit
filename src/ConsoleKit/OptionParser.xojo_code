...
Protected Class OptionParser
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetHasGUI)
		Shared Function ConsoleKitArgs() As String()
		  ...
		  dim args() as string
		    ...
		    args = ParseStringValue(System.ConsoleKit)
		    ...
		    declare function GetConsoleKitW lib "kernel32.dll" () as Ptr
		    declare function ConsoleKitToArgvW lib "shell32.dll" (lpCmdLine As Ptr, ByRef pNumArgs As Integer) As Ptr
		    declare sub LocalFree Lib "kernel32.dll" (p as Ptr)
		    
		    dim cl as Ptr = GetConsoleKitW()
		    dim n as Integer
		    dim argList as Ptr = ConsoleKitToArgvW (cl, n)
	...
	#tag Method, Flags = &h21, CompatibilityFlags = (TargetHasGUI)
		Private Shared Function ParseStringValue(value As String) As String()
		  ...
		  //   used in a Desktop via a call to `System.ConsoleKit` as a Desktop
		  ...
		  '#if TargetWin32 then
		  '
		  '// Code from Michel Bujardet (https://forum.xojo.com/14420-system-ConsoleKit)
		  '
		  'rx.SearchPattern = "(""[^""]+""|[^\s""]+)"
		  '
	...
	#tag Note, Name = Overview
		...
		`System.ConsoleKit` in a Desktop or Web application. It handles actually parsing the
